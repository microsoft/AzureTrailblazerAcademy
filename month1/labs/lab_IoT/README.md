...
## Step 7: Create Output for Stream Analytics job
1. From the left menu, select **Outputs** under **Job topology**, then click **+ Add** and select **Power BI** 
...
## Step 11: Create Power BI Dashboard
