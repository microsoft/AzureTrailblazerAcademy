...
def process_form(value):
    ...
    apim_key = "7b63523b153b47bf983000e5e244b11e"
    #Insert the ID for the form recognizer model
    model_id = "e089fbc0-2000-4b22-9c52-02f4c86f9ed7"
    post_url = endpoint + "/formrecognizer/v2.0/custom/models/%s/analyze" % model_id
    #Azure storage connection string where files will be uploaded
    connectionstring = "DefaultEndpointsProtocol=https;AccountName=asastore1725;AccountKey=a55rhfeKDW75b3zfrdh/OMEIkW/1TfGJukiUp69s6tUHy0Gov6nCL6GLScW7+vFOiVoCpV7uj+gZojzP9/RCJQ==;EndpointSuffix=core.windows.net"
